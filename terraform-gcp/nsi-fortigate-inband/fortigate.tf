...
locals {
  ...
  # License metadata: .lic file content injected at boot
  license_a = var.license_file_a != "" ? file(var.license_file_a) : null
  license_b = var.license_file_b != "" ? file(var.license_file_b) : null
}
