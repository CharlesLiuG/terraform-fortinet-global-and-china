locals {
  ...
  nameSgFTest2     = "sg_ftest2"
  nameSgFTest3     = "sg_ftest3"
}
...
#################### Security Group of FTest-VPC2 ####################
resource "alicloud_security_group" "sgFTest2" {
  name        = local.nameSgFTest2
  description = "FTest2 security group"
...
resource "alicloud_security_group_rule" "sgRuleIngressALL2" {
  type              = "ingress"
  ip_protocol       = "all"
  nic_type          = "intranet"
  policy            = "accept"
  port_range        = "-1/-1"
  priority          = 1
  security_group_id = alicloud_security_group.sgFTest2.id
  cidr_ip           = "0.0.0.0/0"
}


resource "alicloud_security_group_rule" "sgRuleEgressALL2" {
  type              = "egress"
  ip_protocol       = "all"
  nic_type          = "intranet"
  policy            = "accept"
...
#################### Security Group of FTest-VPC3 ####################
resource "alicloud_security_group" "sgFTest3" {
  name        = local.nameSgFTest3
  description = "FTest2 security group"
...
resource "alicloud_security_group_rule" "sgRuleIngressALL3" {
  type              = "ingress"
  ip_protocol       = "all"
  nic_type          = "intranet"
  policy            = "accept"
  port_range        = "-1/-1"
  priority          = 1
  security_group_id = alicloud_security_group.sgFTest3.id
  cidr_ip           = "0.0.0.0/0"
}


resource "alicloud_security_group_rule" "sgRuleEgressALL3" {
  type              = "egress"
  ip_protocol       = "all"
  nic_type          = "intranet"
  policy            = "accept"
