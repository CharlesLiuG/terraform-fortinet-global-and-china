...
#################### vsw FGT ####################
variable "nameVswPublic" {
  type = string
}

variable "nameVswPrivate" {
  type = string
}
...
#################### Vsw FTest-ECS ####################
variable "nameVswFTestVpc2" {
  type = string
}

variable "nameVswFTestVpc3" {
  type = string
}

variable "cidrVswFTestVpc2" {
  type = string
}

variable "cidrVswFTestVpc3" {
  type = string
}
...
#################### Vsw CEN-TR-Landings ####################
variable "cidrVswTRLanding1Vpc1" {
  type = string
}

variable "cidrVswTRLanding2Vpc1" {
  type = string
}

variable "cidrVswTRLanding1Vpc2" {
  type = string
}

variable "cidrVswTRLanding2Vpc2" {
  type = string
}

variable "cidrVswTRLanding1Vpc3" {
  type = string
}

variable "cidrVswTRLanding2Vpc3" {
  type = string
}
...
variable "ipAddrFTestVpc2" {
  type = string
}

variable "ipAddrFTestVpc3" {
  type = string
}
